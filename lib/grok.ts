      ...
      text: JSON.stringify(
        {
          ...
          outdoorUnit: clip(property.outdoorUnit),
          isolatorLocation: clip(property.isolatorLocation),
          indoorHeads: clip(property.indoorHeads),
          refrigerantType: clip(property.refrigerantType),
          mountNotes: clip(property.mountNotes),
          modelSerial: clip(property.modelSerial),
          filterDates: clip(property.filterDates),
