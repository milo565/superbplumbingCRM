...
export async function createCustomer(form: FormData) {
  ...
  const customerNumber = await nextNumber("customer", "KC-");
  const customer = await prisma.customer.create({
    data: {
      ...
      billingState: str(form, "billingState") || "QLD",
...
export async function createProperty(form: FormData) {
  ...
  const property = await prisma.property.create({
    data: {
      ...
      outdoorUnit: str(form, "outdoorUnit") || null,
      isolatorLocation: str(form, "isolatorLocation") || null,
      indoorHeads: str(form, "indoorHeads") || null,
      refrigerantType: str(form, "refrigerantType") || null,
      mountNotes: str(form, "mountNotes") || null,
      modelSerial: str(form, "modelSerial") || null,
      filterDates: str(form, "filterDates") || null,
